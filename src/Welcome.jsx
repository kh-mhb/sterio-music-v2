          ...
          <div className="flex flex-wrap items-center mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
              ...
              <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl">
                Harmonize Your Passion with Music{" "}
              </h1>
              <p className="mb-8 text-base leading-relaxed text-left text-gray-500">
                "Unleash your inner musician and join our online musical class.
                Learn to play your favorite instruments, read sheet music, and
                compose your own melodies from the comfort of your home."
              </p>
